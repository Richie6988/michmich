 ...
 * Inspired by Citymapper/Uber/Wise: minimal, professional.
 */
...
/**
 * Barry Loader — Pulsing pin for loading states.
 */
...
/**
 * Equity indicator dot — colored circle for equity levels.
 */
export function EquityDot({
  score,
  size = 8,
}: {
  score: number;
...
/**
 * Status indicator — small icon for trip/participant status.
 */
